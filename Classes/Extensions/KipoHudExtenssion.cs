...
namespace KipoTupiniquimEngine.Classes.Extensions
{
    public class KipoHudExtenssion : MonoBehaviour
    {
        ...
        public void CreateClock()
        {
            ...
            var clock = UIHelpers.CreateImage(clockAnimation[0], canvas.transform, new(-315, 140, 1), false);
            clock.name = "ClockIcon";
            clock.rectTransform.SetAnchorAndPosition(TextAnchor.UpperLeft);
            ...
            var clockText = UIHelpers.CreateText<TextMeshProUGUI>(BaldiFonts.ComicSans24, "00:00", canvas.transform, new(-268, 134, 1));
            clockText.rectTransform.SetAnchorAndPosition(TextAnchor.UpperLeft);
        ...
        public void CollectPickup(Sprite sprite, Vector3 pos, Vector3 StartPos, float scaleMultiplier = 0.3f)
        {
            var icon = UIHelpers.CreateImage(sprite, canvas.transform, StartPos, false);
